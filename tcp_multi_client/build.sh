...
while true; do
  case "$1" in
    -S|--server)
      ...
      gcc tcp_ser.c services.c network.c -o serv  # Replace with your actual server source file
      shift
      ;;
    -C|--client)
      echo "Building Client program"
      gcc tcp_clnt.c services.c network.c -o clnt # Replace with your actual client source file
      shift
      ;;
    -h|--help)
